...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MY_MESSAGE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NORDIC_VPR_LAUNCHER_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NORDIC_VPR_LAUNCHER_LOG_LEVEL, 3);
